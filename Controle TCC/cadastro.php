...
if (isset($_POST['usuario'])) {
	...
	$mysqli->query("INSERT INTO tb_usuarios (usuario, senha, tipo_usuario, nome, sexo, email, data_nascimento, endereco, numero) VALUES ('$usuario', '$senha', '$tipo', '$nome', '$sexo', '$email', '$data', '$endereco', '$numero')");
	...
	<body>
		...
		<form action="" method="post">
			<div class="container">
    			...
    			<br />
				<br />
    			<a href="login.html"><button type="button" class="btn-cancelar"><b>Voltar para Login</b></button></a>
  			</div>
		</form>
		<script>
